"""
P-ONE Simulation Pipeline — SVG generator
==========================================
No external dependencies. Run with:
    python generate_pipeline.py

Output: p-one_pipeline.svg  (same folder)

LaTeX usage:
    \\usepackage{svg}
    \\includesvg[width=\\textwidth]{figures/p-one_pipeline}

Or convert to PDF first:
    inkscape --export-pdf=p-one_pipeline.pdf p-one_pipeline.svg
...
if __name__ == "__main__":
    output_path = "p-one_pipeline.svg"

...
Usage example:
  python3 /project/def-nahee/kbas/Graphnet-Applications/DataPreperation/trim_GCD.py \
    --gcd-in  /project/6008051/pone_simulation/GCD_Library/PONE_800mGrid.i3.gz \
    --gcd-out /scratch/kbas/default/GCD_default.i3.gz \
    --selection /project/def-nahee/kbas/Graphnet-Applications/Playground/GCD/sub_geometries/default.csv

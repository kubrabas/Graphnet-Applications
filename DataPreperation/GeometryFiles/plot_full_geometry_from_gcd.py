...
#
# Custom output name (saves as /project/def-nahee/kbas/Graphnet-Applications/Metadata/GeometryFiles/spring_2026_mc.png):
#   python3 /project/def-nahee/kbas/Graphnet-Applications/DataPreperation/GeometryFiles/plot_full_geometry_from_gcd.py --name spring_2026_mc
#
# Override GCD path:
#   python3 /project/def-nahee/kbas/Graphnet-Applications/DataPreperation/GeometryFiles/plot_full_geometry_from_gcd.py --gcd /project/6008051/pone_simulation/GCD_Library/PONE_800mGrid.i3.gz --name spring_2026_mc
#
# Custom DPI:
#   python3 /project/def-nahee/kbas/Graphnet-Applications/DataPreperation/GeometryFiles/plot_full_geometry_from_gcd.py --name spring_2026_mc --dpi 300

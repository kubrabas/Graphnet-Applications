...
Usage example:
  python3 create_102_str_gcd.py \
    ...
    --gcd-out /scratch/kbas/98_string/GCD_102strings.i3.gz \
    --selection /project/def-nahee/kbas/Graphnet-Applications/DataPreperation/subset_98/string_ids_102.csv

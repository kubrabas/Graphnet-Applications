...
class PONE(Detector):
    ...
    def __init__(
        ...
        percentiles_csv: str = "/scratch/kbas/FinalParquetDatasets/340_string_muon_nonoise/340_train_feature_percentiles_p25_p50_p75.csv",
        eps: float = 1e-12,
...
class Cfg:
    ...
    train_path: str = "/scratch/kbas/FinalParquetDatasets/340_string_muon_nonoise/merged/train_reindexed"
    val_path: str = "/scratch/kbas/FinalParquetDatasets/340_string_muon_nonoise/merged/val_reindexed"
    test_path: str = "/scratch/kbas/FinalParquetDatasets/340_string_muon_nonoise/merged/test_reindexed"
    ...
    # Outputs
    save_dir: str = "/project/6061446/kbas/Graphnet-Applications/Training/EventPulseSeries_nonoise/presentation/340string"
